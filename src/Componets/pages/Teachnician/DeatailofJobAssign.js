          ...
          <div className="row justify-content-center">
            <div className="d-flex align-items-start">
              ...
              >
                ...
                <button
                  className="nav-link"
                  id="v-pills-technician-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#v-pills-technician"
                  type="button"
                  role="tab"
                ...
                {project && (
                  <>
                    ...
                    <div
                      ...
                      role="tabpanel"
                      aria-labelledby="v-pills-technician-tab"
                    >
                    ...
                    >
                      <div className="d-flex ">
                        ...
                        <TimeSheetModal
                          projectID={projectID}
                          onNewTimesheet={setTimesheetData}
                        />
                                    ...
                                    <td>
                                      {
                                        <button
                                          onClick={() =>
                                            deleteReport(report.id, projectID)
                                          }
                                          className="btn btn-danger btn-sm"
                                        >
                                          {' '}
