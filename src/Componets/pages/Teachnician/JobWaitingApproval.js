...
function JobWaitingApproval() {
  ...
  return (
    <div>
    <div class="mt-3">
<h1 className="text-center">Technician Job waiting approval </h1>
...
{projectList.length === 0 ? (
        <tr>
          <td colSpan="15" className="text-center mt-5 fw-bold fs-3 text-capitalize">No projects waiting for approval</td>
        </tr>
      ) : (
