...
function JobClosed() {
  ...
  return (
    <div>
         <div class="mt-3">
	<h1 className="text-center">Technician Job Completed </h1>
	<div class="bf-table-responsive bf-table-responsive--zebra">
      ...
      {projectList.length === 0 ? (
        <tr>
          <td colSpan="15" className="text-center mt-5 fw-bold fs-3 text-capitalize">No completed data</td>
        </tr>
    ...
    <tr key={index}>
      ...
      <td><Link to={`/DetailsofJobClosed/${project.project_id}`} className="btn btn-primary">See Details
      </Link></td>
    </tr>
  )))}
</tbody>
